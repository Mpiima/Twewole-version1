...
<div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                 <span style="font-size: 18px; font-weight: bold;"> Customer Management</span> <span style="font-size: 13px;">customer list</span><span style="font-size: 15px;">&nbsp;| &nbsp;Customer List</span> 
