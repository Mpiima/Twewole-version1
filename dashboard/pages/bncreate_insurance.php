...
if(isset($_POST['saveloan'])){
    ...
    if ($uploadOk == 1) {
        $insert_products = $dbh->prepare("INSERT INTO products(addedby, type, nature, institution, amount_range, summary, link, 
                ...
                cellspacing="0" width="100%" role="grid" aria-describedby="example_info"
                 style="width: 100%;">
                  ...
                  <tbody>
                    ...
                    where products.status=1 AND products.type='insurance' AND products.addedby = '".$_SESSION['rolenumber']."'  ORDER BY products.auto_id desc ");
