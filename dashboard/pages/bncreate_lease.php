...
<div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                 <span style="font-size: 18px; font-weight: bold;">Operating Lease (Rentals) 
</span>
                  <span style="font-size: 13px;">Operating Lease List</span><span style="font-size: 15px;">&nbsp;| &nbsp;</span> 
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
          //  echo "The file ". htmlspecialchars(basename($_FILES["fileToUpload"]["name"])). " has been uploaded.";
            ...
            $stmt_insert = $dbh->prepare("INSERT INTO products (addedby, type, nature, institution, amount_range, summary,
             link, status, title, loan_id, advert,accountTypeNumber) 
            VALUES (:addedby, 'lease', :nature, :inst, :amount, :summary, :link, :status, :title, :id, :advert,:accountT)");
                ...
                cellspacing="0" width="100%" role="grid" aria-describedby="example_info"
                 style="width: 100%;">
                  ...
                  <tbody>
                    ...
                    where products.status=1 AND products.type='lease' AND products.addedby = '".$_SESSION['rolenumber']."'  ORDER BY products.auto_id desc ");
