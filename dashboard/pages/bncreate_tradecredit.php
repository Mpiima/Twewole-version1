...
<div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                 <span style="font-size: 18px; font-weight: bold;">Tradecredit</span>
                  <span style="font-size: 13px;">tradecredit list</span><span style="font-size: 15px;">&nbsp;| &nbsp;</span> 
          ...
          <div class="modal-content">
            ...
            <div class="row">
                    ...
                    <div class="col-sm-4">
                     <!-- text input -->
                     <div class="form-group">
                        <label>Nature Of the tradecredit</label>
              ...
              <div class="card-body">
                ...
                cellspacing="0" width="100%" role="grid" aria-describedby="example_info"
                 style="width: 100%;">
                  ...
                  <tbody>
                    <?php 
                    // $result_products=$dbh->query("SELECT * FROM products where status=1 AND type='tradeunit' AND addedby='".$_SESSION['rolenumber']."' ORDER BY auto_id desc ");

                     $result_products=$dbh->query("SELECT * FROM products INNER JOIN users ON products.addedby = users.rolenumber
                    where products.status=1 AND products.type='tradeunit' AND products.addedby = '".$_SESSION['rolenumber']."'  ORDER BY products.auto_id desc ");
          ...
          <div class="modal-content">
            ...
            <div class="row">
                    <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        <label>tradecredit Name</label>
                        <input required type="hidden" name="autoid" value="<?php echo $row_products->auto_id; ?>">
