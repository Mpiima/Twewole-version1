...
<div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                 <span style="font-size: 18px; font-weight: bold;">Financing Lease 
</span>
                  <span style="font-size: 13px;">Financing Lease  List</span><span style="font-size: 15px;">&nbsp;| &nbsp;</span> 
  ...
  $summary = trim($_POST['summary']);
    ...
    if ($uploadOk == 0) {
        ...
        $row_type=$result_com->fetchObject();
            ...
            VALUES (:addedby, 'financial-lease', :nature, :inst, :amount, :summary, :link, :status, :title, :id, :advert,:accountT)");
            ...
            if($stmt_insert->execute()){
                ...
                echo "<script>setTimeout(function(){ window.location.href = 'create_finance_lease'; }, 1000);</script>";
            } else {
...
//delete
    ...
    if($delete_products){
     ...
     ?><script>
       var allowed=function(){window.location='create_finance_lease';}
          ...
          <div class="modal-content">
            ...
            <div class="row">
                    ...
                    <div class="col-sm-4">
                     <!-- text input -->
                     <div class="form-group">
                        <label>Nature Of the Financial Lease</label>
                        <select class="form-control" name="nature" required>
                            <option value="">-select-</option>
                            <?php
                    $result_scrap=$dbh->query("SELECT * FROM scrap where item2='financial-lease'");
              ...
              <div class="card-body">
                ...
                cellspacing="0" width="100%" role="grid" aria-describedby="example_info"
                 style="width: 100%;">
                  ...
                  <tbody>
                    <?php 
                    // $result_products=$dbh->query("SELECT * FROM products where status=1 AND type='financial-lease' ORDER BY auto_id desc ");

                     $result_products=$dbh->query("SELECT * FROM products INNER JOIN users ON products.addedby = users.rolenumber 
                    where products.status=1 AND products.type='financial-lease' ORDER BY products.auto_id desc ");
        ...
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            ...
            <div class="row">
                    ...
                    <?php
                    $result_scrap1=$dbh->query("SELECT * FROM scrap where item2='financial-lease' AND autoid='$row_products->nature'");
