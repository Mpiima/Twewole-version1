...
<div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                 <span style="font-size: 18px; font-weight: bold;">Grants</span>
                  <span style="font-size: 13px;">grants list</span><span style="font-size: 15px;">&nbsp;| &nbsp;</span> 
...
//delete
    ...
    if($delete_products){
     ...
     ?><script>
       var allowed=function(){window.location='create_grants';}
              ...
              <div class="card-body">
                ...
                cellspacing="0" width="100%" role="grid" aria-describedby="example_info"
                 style="width: 100%;">
                  ...
                  <tbody>
                    <?php 
                    // $result_products=$dbh->query("SELECT * FROM products where status=1 AND type='grant' ORDER BY auto_id desc ");

                        $result_products=$dbh->query("SELECT * FROM products INNER JOIN users ON products.addedby = users.rolenumber 
                    where products.status=1 AND products.type='grant' ORDER BY products.auto_id desc ");
            ...
            <div class="row">
                ...
                <div class="row">
                  <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        <label>Application Link</label>
                        <input required type="text" class="form-control txtform" name="link" value="<?php echo $row_products->link;  ?>">
                      </div>
                    </div>
                    <div class="col-sm-8">
                    <label>Promotion Image</label>
