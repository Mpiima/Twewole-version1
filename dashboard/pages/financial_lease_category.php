...
<div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                 <span style="font-size: 18px; font-weight: bold;">Financing Lease</span> 
                 <span style="font-size: 13px;">-</span><span style="font-size: 15px;">&nbsp;|
                  &nbsp;Financing Lease Category</span> 
      ...
      $insert_scrap=$dbh->query("INSERT INTO scrap(item,item2,item4)values('$category','$type','$up')");
                ...
                if($insert_scrap){
                    ...
                    ?><script>
                    var allowed=function(){window.location='financial_lease_category';}
