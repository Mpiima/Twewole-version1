...
<style>
   ...
   position: relative;
   min-height: 100%;
   background: url(main/pages/uploads/sliders/slider1.jpg) rgba(255, 0, 0, 0);
   background-size: cover;
         ...
         <div class="col-md-6">
            <div class="newsletter_form">
               <!-- <form method="POST">
                  ...
                  <button type="submit" class="btn btn-dark rounded-0" name="sendemail" value="Submit">Subscribe</button>
                  </form> -->
               <div id="mc_embed_shell">
                  ...
                  <div id="mc_embed_signup">
                     <form action="https://twewole.us22.list-manage.com/subscribe/post?u=fc886a4404c34b3434c07d218&amp;id=641b5db84a&amp;f_id=006fcee1f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
                        <div id="mc_embed_signup_scroll">
                            <div class="row">
                                <div class="col-lg-8">
                                <div class="mc-field-group m-3" >
                           ...
                           <div id="mce-responses" class="clear">
                              ...
                              <div class="response" id="mce-success-response" style="display: none;"></div>
                                ...
                                <!-- <div aria-hidden="true" style="position: absolute; left: -5000px;">
                                    <input type="text" name="b_fc886a4404c34b3434c07d218_641b5db84a" tabindex="-1" value=""></div> -->
                           <div class="clear m-3">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
               ...
               <div class="widget">
                  <ul class="social_icons social_white">
                     <li><a href="https://www.facebook.com/twewoleug" target="_blank"><i class="ion-social-facebook"></i></a></li>
