                ...
                <?php }else{ ?>
                    ...
                    <div class="text-center text-md-end">
                        ...
                        <?php  if($_SESSION['role'] == "BN1" || $_SESSION['role'] == "BN2" || $_SESSION['role'] == "BN3" || $_SESSION['role'] == "BN4" || $_SESSION['role'] == "BN5" || $_SESSION['role'] == "BN6") {  
                               echo '<li><a href="main/pages/dashboard"><i class="ti-home"></i><span>Dashboard</span></a></li>';
                              } else{ ?>
    	...
    	<div class="container">
            <nav class="navbar navbar-expand-lg"> 
                <a class="navbar-brand" href="index " style="width:35%;">
                    <img class="logo_light" style="width:35%" src="main/pages/logo.png" alt="Twewole Ltd" />
                    <img class="logo_dark" style="width:35%" src="main/pages/logo.png" alt="Twewole Ltd" />
                </a>
                                ...
                                <ul class="mega-menu d-lg-flex">
                                    <li class="mega-menu-col col-lg-3">
                                        <ul> 
                                            ...
                                            <?php
                                            $result_scrap=$dbh->query("SELECT * FROM scrap WHERE item2='tradeunit' ORDER BY autoid asc Limit 12");
                                            $count_scrap=$result_scrap->rowCount();
                                            $row_scrap=$result_scrap->fetchObject();
                                            if($count_scrap>0){
                                            do{
                                    ...
                                    <li class="mega-menu-col col-lg-3">
                                        <ul>
                                            ...
                                            <?php
                                            $result_scrap=$dbh->query("SELECT * FROM scrap WHERE item2='tradeunit' ORDER BY autoid asc Limit 12 offset 8");
                                            $count_scrap=$result_scrap->rowCount();
                                            $row_scrap=$result_scrap->fetchObject();
                                            if($count_scrap>0){
                                            do{
                                    ...
                                    <li class="mega-menu-col col-lg-3">
                                        <ul>
                                            ...
                                            <?php
                                            $result_scrap=$dbh->query("SELECT * FROM scrap WHERE item2='tradeunit' ORDER BY autoid asc Limit 12 offset 16");
                                            $count_scrap=$result_scrap->rowCount();
                                            $row_scrap=$result_scrap->fetchObject();
                                            if($count_scrap>0){
                                            do{
                                    ...
                                    <li class="mega-menu-col col-lg-3">
                                        <ul>
                                            ...
                                            <?php
                                            $result_scrap=$dbh->query("SELECT * FROM scrap WHERE item2='tradeunit' ORDER BY autoid asc Limit 12 offset 24");
                                            $count_scrap=$result_scrap->rowCount();
                                            $row_scrap=$result_scrap->fetchObject();
                                            if($count_scrap>0){
                                            do{
