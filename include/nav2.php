        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg"> 
                <a class="navbar-brand" href="index" style="width:35%;">
                    <img class="logo_light" style="width:35%" src="dashboard/pages/logo.png" alt="Comp" />
                    <img class="logo_dark" style="width:120px;position:absolute;top:-10px;" src="dashboard/pages/logo.png" alt="Companygo "
                    />
                </a>
