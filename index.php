                        ...
                        <div class="popup_content">
                            <div class="popup-text">
                                <div class="heading_s3 text-center">
                                    <h4>Subscribe and Get Latest offers!</h4>
                                </div>
...
<div class="banner_section full_screen staggered-animation-wrap">
    <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow carousel_style2" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active background_bg overlay_bg_50" data-img-src="main/pages/uploads/sliders/slider1.jpg">
            ...
            <div class="carousel-item background_bg overlay_bg_50" data-img-src="main/pages/uploads/sliders/slider2.jpg">
                <div class="banner_slide_content banner_content_inner">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-7 col-md-10">
...
Get connected to Loans, Trade credit, Asset leasing, and Grants to support your financial needs.</p>
            ...
            <div class="carousel-item background_bg overlay_bg_60" data-img-src="main/pages/uploads/sliders/baq.jpg">
                <div class="banner_slide_content banner_content_inner">
                    <div class="container">
                        <div class="row justify-content-center">
    	...
    	<div class="row align-items-center flex-row-reverse">
            ...
            <div class="col-md-5">
                <div class="text-center trading_img">
                    <img src="main/pages/uploads/sliders/slider1.jpg" alt="tranding_img"/>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="tab-content">
                    ...
                    <?php
                        ...
                        <span>Apply</span></a></div>
                                  ...
                                  <a href="s?id=<?php echo $row_c->autoid; ?>&target=<?php echo 'loan'; ?>" class="btn btn-light btn-sm"><?php echo $row_c->item; ?></a>
                                </div>                                                         
                              </div>
                              </div>
                    ...
                    <?php
                            ...
                            do{
                                if($row_c->item4 == ""){
                                    $img = "main/pages/uploads/download.png";
                                    }else{
                                     $img=$row_c->item4;
                                    }
                            ?>
    	...
    	<div class="row">
            <div class="col-lg-7 col-md-8 col-sm-9">
            	<div class="furniture_banner">
                    ...
                    <div class="countdown_time countdown_style3 mb-4" data-time="2024/09/02 12:30:15"></div>
...
<div class="section pb_0">
	<div class="container">
        ...
        <img src="main/pages/uploads/How it works icons-get account.jpg" 
          ...
          <div class="col-lg-4">
          <div class="container text-center">
        <img src="main/pages/uploads/How it works icons-engage with financiers.jpg" 
            class="img-flui circle" alt="GFG" style="border-radius:50%; width:160px;height:160px;">
        ...
        <a href="/getstarted" class="btn btn-white staggered-animation"><b>GET STARTED NOW</b></a>
          ...
          <div class="col-lg-4">
          <div class="container text-center">
        <img src="main/pages/uploads/How it works icons-seal deal .jpg" 
            class="img-flui circle" alt="GFG" style="border-radius:50%; width:160px;height:160px;">
...
<div class="social-media-bar">
    <ul>
        <li><a href="https://www.facebook.com/twewoleug"><i class="fab fa-facebook-f"></i></a></li>
