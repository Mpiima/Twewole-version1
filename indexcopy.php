...
<div class="banner_section full_screen staggered-animation-wrap">
    <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow carousel_style2" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active background_bg overlay_bg_50" data-img-src="main/pages/uploads/sliders/1.jpg">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7 col-md-10">
                                <div class="banner_content text_white text-center">
                                    ...
                                    <a class="btn btn-white staggered-animation" href="services?target=loans" data-animation="fadeInUp" data-animation-delay="0.5s">Get Credit</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="carousel-item background_bg overlay_bg_50" data-img-src="main/pages/uploads/sliders/5.jpg">
                <div class="banner_slide_content banner_content_inner">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-7 col-md-10">
                                <div class="banner_content text_white text-center">
                                    ...
                                    <p class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.4s">Are you an Individual or a Small business? Twewole  is your Link to Credit.
Get connected to Loans, Trade credit, Asset leasing, and Grants to support your financial needs.</p>
                                    <a class="btn btn-white staggered-animation" href="services?target=loans" data-animation="fadeInUp" data-animation-delay="0.4s">Get Connected</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="carousel-item background_bg overlay_bg_60" data-img-src="main/pages/uploads/sliders/Fv2cPZQWcAIbbSj.jpg">
                <div class="banner_slide_content banner_content_inner">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-7 col-md-10 mt-5">
                                <div class="banner_content text_white text-center">
                                    ...
                                    <p class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.4s">Get access to Credit experts, Insurance, Business partners and Tools that guide you towards financial success.</p>
                                    <a class="btn btn-white staggered-animation" href="services?target=loans" data-animation="fadeInUp" data-animation-delay="0.4s">Get Connected</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-4">
                            <div class="text-center text-md-start">
                                <h4>Social Media</h4>
                                <p class="mb-2"> Follow us for insightful money, credit and finance content to help you succeed. Let’s take on this challenge together! </p>
                                <a href="contactus" class="btn btn-line-fill btn-sm">Try Us </a>
                            </div>
                        </div>
                            ...
                            <div class="cat_slider mt-4 mt-md-0 carousel_slider owl-carousel owl-theme nav_style5" data-loop="true" data-dots="false" data-nav="true" data-margin="30" data-responsive='{"0":{"items": "1"}, "380":{"items": "2"}, "991":{"items": "3"}, "1199":{"items": "4"}}'>
                                <div class="item">
                                    <div class="categories_box">
                                        <a href="https://www.facebook.com/twewoleug" style="color: #3b5998;">
                                ...
                                <!-- <div class="item">
                                    <div class="categories_box">
                                        <a href="https://wa.me/256743070700"  style="color: #ac2bac;">
                                ...
                                <div class="item">
                                    <div class="categories_box">
                                        <a href="https://www.linkedin.com/tweowole/" style="color:  #0082ca;">
...
<div class="section pb_10">
	<div class="container">
        ...
        <img src="assets/images/1.svg" 
            ...
            <h3 class="text-success">Get a Twewole Account for Free
        </h3>
    </div>
          </div>
          <div class="col-lg-4">
...
"assets/images/3.png" 
            class="img-flui circle" alt="GFG" style="border-radius:50%; width:160px;height:160px;">
            <h3 class="text-success"> Login and Engage with Financiers
        </h3>
        <a href="/getstarted" class="btn btn-warning"> <h2 style="font-size:25px;">GET STARTED NOW</h2></a>
    </div>
          </div>
          <div class="col-lg-4">
          <div class="container text-center">
...
"assets/images/4.png" 
            class="img-flui circle" alt="GFG" style="border-radius:50%; width:160px;height:160px;">
            <h3 class="text-success">Seal Deal & Get Credit
        </h3>
    </div>
        	...
        	<div class="col-12">
            	<div class="tab-style1">
                    <ul class="nav nav-tabs justify-content-center" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="special-tab" data-bs-toggle="tab" href="#leasing" role="tab" aria-controls="special" aria-selected="false">Asset Leasing</a>
                        </li>
                ...
                <div class="tab-content">
                    ...
                    <?php
                            ...
                            do{
                            ?>
                        <div class="col-md-3" style="background-img:url('lg.png')">
                    ...
                    <?php
                            ...
                            ?>
                        <div class="col-md-3">
                        <a href="products?id=<?php echo $row_c->autoid; ?>&target=<?php echo 'grant'; ?>">
                        <div class="card p-3 mb-2">
                        <div class="d-flex justify-content-between">
                        <div class="badge"> <span>Apply</span> </div>
                        </div>
                    ...
                    <?php
                            ...
                            ?>
                        <div class="col-md-3">
                        <a href="products?id=<?php echo $row_c->autoid; ?>&target=<?php echo 'tradeunit'; ?>">
                ...
                <div class="testimonial_box">
                        ...
                        <div class="author_wrap">
                            <div class="author_img">
                                <img src="main/pages/<?php echo $row_test->pic; ?>" alt="user_img1" />
                            </div>
                ...
                <div class="col-lg-4">	
                    <div class="icon_box icon_box_style1">
                        ...
                        <div class="icon_box_content">
                            ...
                            <p> We are committed to addressing customer issues and being transparent with our intentions. </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">	
