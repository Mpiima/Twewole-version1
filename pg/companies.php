...
$insert_company=$dbh->query("INSERT INTO scrap(item,type,item2,item3,item4,item5)values('$company','$item2','$contact','$address','$target_file','$category')");
if($insert_company){
