...
<div class="breadcrumb_section page-title-mini" style="margin-top:0px;margin-bottom: 0px; background-image: url('assets/images/money.jpg'); max-width: 100%; padding: 30px;padding-top: 100px; height: 100px !important; background-repeat:no-repeat; background-size: cover;" >
